...
const GET_TOTAL_RAW_MATERIALS_IN_INVENTORY = API_URL + "/total-raw-materials-in-inventory";
const GET_TOTAL_FOOD_ITEMS_IN_INVENTORY = API_URL + "/total-food-items-in-inventory";
...
const GET_PURCHASED_VS_USED_RAW_MATERIAL = API_URL + "/purchased-vs-used-raw-materials/"
...
module.exports = {
  ...
  LOGIN,
  REGISTER,
  GET_LOW_INVENTORY, GET_TOTAL_RAW_MATERIALS_IN_INVENTORY, GET_TOTAL_FOOD_ITEMS_IN_INVENTORY,
  GET_TOTAL_EXPENDITURE, GET_EXPECTED_REVENUE, GET_MOST_USED_RAW_MATERIAL, GET_PURCHASED_VS_USED_RAW_MATERIAL,
  GET_VENDORS,
