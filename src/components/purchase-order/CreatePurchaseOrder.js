                                        ...
                                        {this.state.order.selectedRawMaterials.map((rawMaterial) =>
                                            <ListGroup.Item key={rawMaterial.id}>
                                                <Row>
                                                    ...
                                                    <Col sm={1}>
                                                        <FontAwesomeIcon icon={faTrashAlt} color={"#ba2311"} onClick={() => this.deleteRawMaterial(rawMaterial)}/>
                                                    </Col>
                                                </Row>
                                            </ListGroup.Item>
                                        )}
                                ...
                                <Col sm={12}>
                                    <Form.Group controlId="vendor">
                                        ...
                                        {isError.selectedVendor.length > 0 && (
                                            <Form.Control.Feedback type={"invalid"}>{isError.selectedVendor}</Form.Control.Feedback>
                                        )}
                                    </Form.Group>
                                </Col>
                            </Row>
                            <Row className={"mt-3"}>
                                <Col>
                                    <Form.Group controlId="rawMaterials">
                                        ...
                                        <ListGroup className={isError.selectedRawMaterials.length > 0 ? "is-invalid mt-3 po-raw-material-list" : "mt-3 po-raw-material-list"}>
                                        ...
                                        {isError.selectedRawMaterials.length > 0 && (
                                            <Form.Control.Feedback type={"invalid"}>{isError.selectedRawMaterials}</Form.Control.Feedback>
                                        )}
                                    </Form.Group>
                                </Col>
                            </Row>
                ...
                <Modal show={this.state.rawMaterialQuantityModal.show} animation={false} onHide={this.closeModal}>
                    ...
                    <Modal.Body>
                        <Form.Group>
                            ...
                            <Form.Control plaintext readOnly defaultValue={this.state.rawMaterialQuantityModal.selectedRawMaterial.name} className={"p-0"}/>
                        </Form.Group>
                        <Form.Group>
                            ...
                            {isError.selectedRawMaterialQuantity.length > 0 && (
                                <Form.Control.Feedback type={"invalid"}>{isError.selectedRawMaterialQuantity}</Form.Control.Feedback>
                            )}
                        </Form.Group>
                    </Modal.Body>
                    <Modal.Footer>
