...
import {Button, Card, Col, FormControl, InputGroup, Row, Table, ListGroup} from "react-bootstrap";
import {FontAwesomeIcon} from "@fortawesome/react-fontawesome";
import {faEdit, faPen, faSearch, faTrash, faTrashAlt} from "@fortawesome/free-solid-svg-icons";
            ...
            <section>
                ...
                <Row className="m-3">
                    <Col sm={8} className={"text-left"}>
                        <Button  variant={"success"} onClick={this.goToAddRawMaterial.bind(this)}>
                            Add Raw Material
                        </Button>
                    </Col>
                    <Col sm={4}>
                                ...
                                <ListGroup className={"mt-3"}>
                                    ...
                                    {this.state.rawMaterialList.map((item) =>
                                        ...
                                        <Row>
                                            ...
                                            <Col sm={2}>
                                                <FontAwesomeIcon icon={faPen} className={"mr-5"} color={"#4e301b"} onClick={()=>this.goToEditRawMaterial()}/>
                                                <FontAwesomeIcon icon={faTrash} color={"#ba2311"} onClick={()=>this.deleteRawMaterial(item)}/>
                                            </Col>
                                        </Row>
                                        </ListGroup.Item>
                                        )}
